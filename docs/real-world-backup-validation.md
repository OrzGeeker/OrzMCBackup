...
> 🔀 **本文档是 2026-08-17 的早期验证（~14 GB 世界）。** 更新的 2026-08-19 实测
> （18.6 GB 恢复合并世界、六档阈值 0/60/120/180/240/300s、逐字节完整性验证）见
> **[`threshold-benchmark-report.md`](threshold-benchmark-report.md)**，数据以新报告为准。
